        ...
        <div class="row">
          <div class="cul-lg-9">
            <div class="card card-margin">
              <div class="card-header no-border d-flex justify-content-between ">
                ...
                <p class="card-title" style={{marginLeft:"1rem"}}><b>Author: </b> Sachin V</p>
          ...
          <div class="cul-lg-9">
            <div class="card card-margin">
              ...
              <p class="card-title" style={{marginLeft:"1rem"}}><b>Author: </b> Joy Almedia</p>
              <div class="card-body pt-0">
                <div class="widget-49">
                  <div class="widget-49-title-wrapper">
                    <div class="widget-49-date-primary">
                  ...
                  <ul class="widget-49-meeting-points">
                    <li class="widget-49-meeting-item">
                      <span>
                        ...
                        running the Image Cullection python file that cullects
          ...
          <div class="cul-lg-9">
            <div class="card card-margin">
              ...
              <p class="card-title" style={{marginLeft:"1rem"}}><b>Author: </b>Jeet Mistry</p>
              <div class="card-body pt-0">
                <div class="widget-49">
                  <div class="widget-49-title-wrapper">
                    <div class="widget-49-date-primary">
          ...
          <div class="cul-lg-9">
            <div class="card card-margin">
              ...
              <p class="card-title" style={{marginLeft:"1rem"}}><b>Author: </b>Aakash Dubey</p>
              <div class="card-body pt-0">
                <div class="widget-49">
                  <div class="widget-49-title-wrapper">
                    <div class="widget-49-date-primary">
